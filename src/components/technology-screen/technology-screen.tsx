...
import { technologies } from '../../descriptions-slider-images';
...
function TechnologyScreen() {
  return (
    <section id="technology-screen" className="technology">
      ...
      <div className="technology__list">
        <div className="technology__image-wrapper">
          ...
          <button className="technology__upscale-button" type="button">
